...
export const storeProfileStyles = {
  ...
  accountActions: "mt-5 lg:mt-auto",
  pinSettingsArea: "grid gap-2",
  pinSettingsButton: `${storeActionStyles.neutral} w-full`,
  pinStatusError: "text-sm leading-5 text-[var(--danger)]",
  logoutArea: "mt-3",
  ...
  dialogDetailActions: "mt-6 grid grid-cols-3 gap-2",
  dialogLedger: `${storeActionStyles.ledger} min-w-0 whitespace-nowrap px-1 text-xs sm:px-2 sm:text-sm`,
  dialogDanger: `${storeActionStyles.danger} min-w-0 whitespace-nowrap px-1 text-xs sm:px-2 sm:text-sm`,
