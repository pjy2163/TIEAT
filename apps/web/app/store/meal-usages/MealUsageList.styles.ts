export const mealUsageListStyles = {
  ...
  confirmationSummary: "mt-4 grid grid-cols-2 gap-3 rounded-xl border border-[var(--border)] bg-white p-4 text-sm sm:grid-cols-4 [&_div]:min-w-0 [&_dt]:text-[var(--text-muted)] [&_dd]:mt-1 [&_dd]:break-words [&_dd]:text-[var(--text-primary)]",
