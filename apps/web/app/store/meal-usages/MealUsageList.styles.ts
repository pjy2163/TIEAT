export const mealUsageListStyles = {
  ...
  successDescription: "mt-0.5 break-words text-sm leading-5 text-[#397d55]",
  ...
  initialsInput: "mt-2 h-11 w-full rounded-lg border border-[var(--border-strong)] bg-white px-3 text-base text-[var(--text-primary)] outline-none transition focus:border-[var(--accent)] focus:ring-2 focus:ring-[#dbe4ff] disabled:bg-[var(--surface)]",
  initialsHint: "mt-2 text-sm text-[var(--text-secondary)]",
  ...
  terminalActions: "mt-4 grid gap-3 sm:grid-cols-2",
  confirmInActionGroup: "inline-flex h-11 w-full items-center justify-center rounded-lg bg-[var(--accent)] px-4 text-sm font-semibold text-white transition-colors hover:bg-[#244cda] disabled:cursor-not-allowed disabled:bg-[#98abef]",
  reject: "inline-flex h-11 w-full items-center justify-center rounded-lg border border-[#efbbc2] bg-white px-4 text-sm font-semibold text-[var(--danger)] transition-colors hover:bg-[#fff7f8] disabled:cursor-not-allowed disabled:text-[#d9a2aa]",
