export const monthlyMealUsageListStyles = {
  ...
  paymentMeta: "grid min-w-0 flex-1 grid-cols-[4.5rem_4rem_max-content] items-center justify-end gap-x-4",
  amount: "w-[4.5rem] whitespace-nowrap text-right text-base font-semibold leading-6 tabular-nums text-[var(--text-primary)]",
  confirmedInitials: "inline-flex w-16 items-center justify-self-end whitespace-nowrap text-right text-sm font-medium leading-5 text-[var(--text-secondary)]",
