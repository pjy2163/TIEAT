export const monthlyMealUsageListStyles = {
  ...
  row: "grid grid-cols-[minmax(0,1fr)_auto] gap-x-4 gap-y-4 px-5 py-5 sm:px-6 md:items-start",
  ...
  customer: "mt-2",
  side: "flex min-w-0 flex-col items-end gap-1 text-right md:min-w-36",
  amount: "whitespace-nowrap text-base font-semibold leading-6 tabular-nums text-[var(--text-primary)]",
