...
export const monthlyMealUsageListStyles = {
  ...
  customerRow: "mt-2 flex min-w-0 flex-col items-stretch gap-1 sm:flex-row sm:items-center sm:gap-3",
  paymentMeta: "grid min-w-0 grid-cols-[minmax(0,1fr)_auto_auto] items-center justify-end gap-x-2 sm:flex-1 sm:grid-cols-[4.5rem_4rem_max-content] sm:gap-x-4",
  ...
  confirmedInitials: "inline-flex min-w-0 items-center justify-self-end whitespace-nowrap text-right text-sm font-medium leading-5 text-[var(--text-secondary)] sm:w-16",
