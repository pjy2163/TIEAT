export const monthlyMealUsageListStyles = {
  ...
  selectionBar: "fixed inset-x-0 bottom-0 z-30 border-t border-[var(--border-strong)] bg-white/95 shadow-[0_-8px_24px_rgba(17,24,39,0.08)] backdrop-blur supports-[backdrop-filter]:bg-white/85",
