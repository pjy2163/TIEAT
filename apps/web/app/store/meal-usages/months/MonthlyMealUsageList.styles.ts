export const monthlyMealUsageListStyles = {
  ...
  row: "grid grid-cols-[minmax(0,1fr)_auto] items-stretch gap-x-4 gap-y-4 px-5 py-5 sm:px-6",
  ...
  customerRow: "mt-2 flex min-w-0 items-center justify-between gap-4",
  side: "grid min-w-0 grid-rows-3 items-center justify-items-end text-right md:min-w-36",
  amount: "shrink-0 whitespace-nowrap text-base font-semibold leading-6 tabular-nums text-[var(--text-primary)]",
  confirmedInitials: "row-start-2 inline-flex items-center whitespace-nowrap text-sm font-medium leading-5 text-[var(--text-secondary)]",
  settlementStatus: "row-start-3 inline-flex items-center justify-end gap-1 whitespace-nowrap text-sm font-semibold leading-5 text-[#244cda]",
