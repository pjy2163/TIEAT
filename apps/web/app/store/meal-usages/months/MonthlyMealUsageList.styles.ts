export const monthlyMealUsageListStyles = {
  ...
  side: "flex min-w-0 flex-col items-end justify-center gap-2 text-right md:min-w-36",
  amount: "shrink-0 whitespace-nowrap text-base font-semibold leading-6 tabular-nums text-[var(--text-primary)]",
  confirmedInitials: "whitespace-nowrap text-sm font-medium leading-5 text-[var(--text-secondary)]",
  settlementStatus: "whitespace-nowrap text-sm font-semibold leading-5 text-[#244cda]",
